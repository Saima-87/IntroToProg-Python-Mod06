...
# Saima,11/17/2023,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class FileProcessor:
    ...
    Saima,11.18.2023,Created Class
    """

    @staticmethod
    def read_data_from_file(file_name: str, student_data: list) -> list:

        """ This function reads data from the json file and loads it into a list of dictionary

        ChangeLog: (Who, When, What)
        Saima,11.18.2023,Created function
        :return: list
                """
        try:
    ...
    def write_data_to_file(file_name: str, student_data: list):
        """ This function writes data to the json file with data from list of dictionary
...
class IO:
    ...
    def output_student_courses(student_data: list):
        """ This function displays the student name and course name to the user
...
while (True):
    ...
    # User selects the choice ffrom the menu
